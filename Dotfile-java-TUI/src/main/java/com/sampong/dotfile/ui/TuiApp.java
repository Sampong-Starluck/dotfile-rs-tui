...
import com.sampong.dotfile.feature.catalog.AppsView;
import com.sampong.dotfile.feature.catalog.SectionsController;
import com.sampong.dotfile.feature.catalog.SectionsView;
import com.sampong.dotfile.feature.installed.InstalledView;
import com.sampong.dotfile.feature.managers.CommandsView;
import com.sampong.dotfile.feature.managers.ManagersController;
import com.sampong.dotfile.feature.managers.ManagersView;
import com.sampong.dotfile.feature.scripts.ShellInfoView;
import com.sampong.dotfile.feature.scripts.ShellsController;
import com.sampong.dotfile.feature.scripts.ShellsView;
import com.sampong.dotfile.feature.search.SearchResultsView;
import com.sampong.dotfile.feature.status.StatusController;
import com.sampong.dotfile.feature.status.StatusView;
...
public class TuiApp extends ToolkitApp {
    ...
    protected Element render() {
        ...
        Column root = LazygitLayout.frame(
                ...
                Panels.framed(PanelId.MAIN.elementId(), "Main", mainViews.get(st.mainView).render(st)),
                HintBar.of(keyHints()),
